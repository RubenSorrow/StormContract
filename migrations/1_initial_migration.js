...
module.exports = async function (deployer) {
  ...
  await deployer.deploy(proxyContract, 3050000000000, "Bolts", "BOLT", 6).then(async () => {
    await deployer.deploy(zeusContract, proxyContract.address, 100000).then(async () => {
      //Reserve of 0 token, interest of 0.25, antidumping of 5, no beneficiary set, no logic set
      await deployer.deploy(perpetualProxy, 250000, 5000000, "0x6E27D0d89AD3e93cbb3938f55a7f91e34C861732", proxyContract.address).then(async () => {
